...
class _$SearchStateTearOff {
  ...
  _SearchState call(
      {required List<SearchRespo> searchResultList,
...
/// @nodoc
mixin _$SearchState {
  List<SearchRespo> get searchResultList => throw _privateConstructorUsedError;
...
abstract class $SearchStateCopyWith<$Res> {
  ...
  $Res call(
      {List<SearchRespo> searchResultList,
...
class _$_SearchState implements _SearchState {
  ...
  @override
  final List<SearchRespo> searchResultList;
  @override
...
abstract class _SearchState implements SearchState {
  ...
  @override
  List<SearchRespo> get searchResultList;
  @override
